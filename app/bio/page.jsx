...
const Home = () => {
  ...
  return (
    <section>
        <a href="#about" className={`${scrollY > 1500 ? "bg-black/40 pointer-events-auto" : "bg-black/0 pointer-events-none"} ${scrollY > 1500 ? "cursor-pointer" : "cursor-default"} flex items-center justify-center transition-all ease-in-out duration-150 fixed w-14 h-14 lg:w-20 lg:h-20 z-50 right-0 bottom-36`}>
